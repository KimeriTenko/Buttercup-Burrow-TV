...
const Contact = () => {
  return (
    <div title='contact' className='w-full h-screen bg-[#F8FAF6] flex justify-center items-center p-4'>
        <form method='POST' action="https://getform.io/f/e4587336-1a64-4c7d-b3fd-b8f762085ecb" className='flex flex-col max-w-[600px] w-full'>
            ...
            <textarea rows={10} 
            className='bg-[#F8D894] p-2' name='message' placeholder='Message'></textarea>
